...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_back(PyObject *self, PyObject *arg0)
{
  node * * x0;
  Py_ssize_t datasize;
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_create_linkedlist(PyObject *self, PyObject *noarg)
{
  node * * result;
  PyObject *pyresult;
...
#else
#  define _cffi_f_create_linkedlist _cffi_d_create_linkedlist
#endif

static int _cffi_d_empty(node * * x0)
{
  return empty(x0);
}
#ifndef PYPY_VERSION
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_front(PyObject *self, PyObject *arg0)
{
  node * * x0;
  Py_ssize_t datasize;
  struct _cffi_freeme_s *large_args_free = NULL;
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_pop_back(PyObject *self, PyObject *arg0)
{
  node * * x0;
  Py_ssize_t datasize;
  struct _cffi_freeme_s *large_args_free = NULL;
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_pop_front(PyObject *self, PyObject *arg0)
{
  node * * x0;
  Py_ssize_t datasize;
  struct _cffi_freeme_s *large_args_free = NULL;
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_push_back(PyObject *self, PyObject *args)
{
  node * * x0;
  int x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "push_back", 2, 2, &arg0, &arg1))
    return NULL;
...
#else
#  define _cffi_f_push_back _cffi_d_push_back
#endif

static void _cffi_d_push_front(node * * x0, int x1)
{
  push_front(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_push_front(PyObject *self, PyObject *args)
{
  node * * x0;
  int x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "push_front", 2, 2, &arg0, &arg1))
    return NULL;
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_value_at(PyObject *self, PyObject *args)
{
  node * * x0;
  int x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "value_at", 2, 2, &arg0, &arg1))
    return NULL;
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_linkedlist_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_linkedlist_cffi(void) { return NULL; }
#  else
     initlinkedlist_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_linkedlist_cffi(void)
{
  return _cffi_init("linkedlist_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initlinkedlist_cffi(void)
{
  _cffi_init("linkedlist_cffi", 0x2601, &_cffi_type_context);
}
#endif
