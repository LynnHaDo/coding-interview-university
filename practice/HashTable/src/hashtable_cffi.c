...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 4), // hashtable *()(int)
...
_cffi_f_add(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "add", 3, 3, &arg0, &arg1, &arg2))
    return NULL;

  datasize = _cffi_prepare_pointer_call_argument(
      _cffi_type(4), arg0, (char **)&x0);
  if (datasize != 0) {
    x0 = ((size_t)datasize) <= 640 ? (hashtable *)alloca((size_t)datasize) : NULL;
...
static hashtable * _cffi_d_create_hashtable(int x0)
{
  return create_hashtable(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_create_hashtable(PyObject *self, PyObject *arg0)
{
  int x0;
  hashtable * result;
  PyObject *pyresult;
...
#else
#  define _cffi_f_create_hashtable _cffi_d_create_hashtable
#endif

static int _cffi_d_exists(hashtable * x0, int x1)
{
  return exists(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_exists(PyObject *self, PyObject *args)
{
  hashtable * x0;
  int x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "exists", 2, 2, &arg0, &arg1))
    return NULL;
...
#else
#  define _cffi_f_exists _cffi_d_exists
#endif

static optional_int _cffi_d_get_key(hashtable * x0, int x1)
{
  return get_key(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_get_key(PyObject *self, PyObject *args)
{
  hashtable * x0;
  int x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "get_key", 2, 2, &arg0, &arg1))
    return NULL;
...
#else
static void _cffi_f_get_key(optional_int *result, hashtable * x0, int x1)
{
  { *result = get_key(x0, x1); }
}
#endif
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_hash(PyObject *self, PyObject *args)
{
  hashtable * x0;
  int x1;
  Py_ssize_t datasize;
...
#else
#  define _cffi_f_hash _cffi_d_hash
#endif

static int _cffi_d_indexof(hashtable * x0, int x1)
{
  return indexof(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_indexof(PyObject *self, PyObject *args)
{
  hashtable * x0;
  int x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "indexof", 2, 2, &arg0, &arg1))
    return NULL;
...
#else
#  define _cffi_f_indexof _cffi_d_indexof
#endif

static optional_int _cffi_d_remove_key(hashtable * x0, int x1)
{
  return remove_key(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_remove_key(PyObject *self, PyObject *args)
{
  hashtable * x0;
  int x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "remove_key", 2, 2, &arg0, &arg1))
    return NULL;
...
#else
static void _cffi_f_remove_key(optional_int *result, hashtable * x0, int x1)
{
  { *result = remove_key(x0, x1); }
}
#endif
...
_CFFI_UNUSED_FN
static void _cffi_checkfld__hashtable(hashtable *p)
{
...
_CFFI_UNUSED_FN
static void _cffi_checkfld__item(item *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  (void)((p->key) | 0);  /* check that 'item.key' is an integer */
  (void)((p->value) | 0);  /* check that 'item.value' is an integer */
}
struct _cffi_align__item { char x; item y; };
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_hashtable_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_hashtable_cffi(void) { return NULL; }
#  else
     inithashtable_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_hashtable_cffi(void)
{
  return _cffi_init("hashtable_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
inithashtable_cffi(void)
{
  _cffi_init("hashtable_cffi", 0x2601, &_cffi_type_context);
}
#endif
